...
export interface _SERVICE {
  'actionReport' : ActorMethod<
    ...
    Result
  >,
  'addNewSponsor' : ActorMethod<[string, string, bigint], Result>,
  ...
  'claimAssetSupport' : ActorMethod<[string], Result>,
  'createAsset' : ActorMethod<
    ...
    Result
  >,
  'createAssetGuarantee' : ActorMethod<[string, string, bigint], Result>,
  ...
  'createReportAsset' : ActorMethod<
    ...
    Result
  >,
  'distributeDividend' : ActorMethod<[string, bigint], Result>,
  ...
  'getIncome' : ActorMethod<[string], [] | [Array<Transaction>]>,
  ...
  'initializeNewAssetSponsor' : ActorMethod<[string, string, bigint], Result>,
